    ...
    return (
        ...
        <header id="header">
            <div className="averager">
                ...
                <button className="toggle-navbar" onClick={() => {
                    window.document.getElementsByClassName("header_options-mobile")[0].classList.toggle("d-block")
                    document.body.style.overflow = "hidden"
                }}><HiMenu /></button>

                <div className="header_options-mobile">
                    <button class="mobile-overlay-close" onClick={() => {
                        window.document.getElementsByClassName("header_options-mobile")[0].classList.toggle("d-block")
